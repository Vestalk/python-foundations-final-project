...
Адресна книга автоматично завантажується з `addressbook.pkl` у домашній
папці користувача при старті (якщо файл існує) і зберігається туди ж при
виході командою `close`/`exit`.
...
Якщо в назві команди є одруківка, помічник запропонує найближчу відому
команду.
